...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('flexstart') }}/img/favicon.png" rel="icon">
  <link href="{{ asset('flexstart') }}/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="{{ asset('flexstart') }}/vendor/remixicon/remixicon.css" rel="stylesheet">
  ...
  <link href="{{ asset('flexstart') }}/css/style.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="{{asset('flexstart/img/logo.png') }}" alt="">
        <span>FlexStart</span>
      </a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="{{asset('kanas.png')}}" height="200px" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright 2021<strong><span>Kana's Kitchen</span></strong>
      </div>
      <div class="credits">
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset ('flexstart/vendor/bootstrap/js/bootstrap.bundle.js') }}"></script>
  ...
  <script src="{{asset ('flexstart/vendor/purecounter/purecounter.js') }}"></script>
