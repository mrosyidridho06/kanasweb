                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label>Nama Karyawan</label>
                                <input type="text" name="nama_karyawan" id="nama_karyawan" class="form-control @error('nama_karyawan') is-invalid @enderror" value="{{ $karyawan->nama_karyawan }}" />
                                @error('nama_karyawan')
                        ...
                        <div class="col-md-6">
                            <label>Jenis Kelamin</label>
                                <select class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" value="{{ $karyawan->jenis_kelamin }}">
                        ...
                        <div class="col-md-6">
                            <label>Hp</label>
                                <input type="text" name="hp_karyawan" id="hp_karyawan" class="form-control @error('hp_karyawan') is-invalid @enderror" value="{{ $karyawan->hp_karyawan }}" />
                                @error('hp_karyawan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <label>Agama</label>
                            <select class="form-control @error('agama') is-invalid @enderror" name="agama" value="{{ $karyawan->agama }}">
                        ...
                        <div class="col-md-6">
                            <label>Jabatan</label>
                                <input type="text" name="jabatan" id="jabatan" class="form-control @error('jabatan') is-invalid @enderror" value="{{ $karyawan->jabatan }}" />
                                @error('jabatan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
